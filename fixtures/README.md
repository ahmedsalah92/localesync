...
| `preview.fig` | Apply, switch, edit, revert, storage and undo counts → LS-12. **Writes plugin data** (Extract stamps) — never reuse another fixture for it. Import files `preview/de.json` and `preview/translations.csv` sit alongside | `preview.md` | **Generate preview** | pending — not yet generated |
